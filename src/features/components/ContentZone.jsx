...
// @ts-ignore
const ContentZone = ({ quizActive, setQuizActive, customQuizActive, setCustomQuizActive, currentQuiz, setCurrentQuiz, qNumber, setQNumber, score, setScore, createActive, setCreateActive, createQuiz, customQuiz }) => {
  return (
    <div className='h-screen flex justify-center items-center'>
        {!quizActive && !createActive && !customQuizActive && <Quizzes quizActive={quizActive} setQuizActive={setQuizActive} setCurrentQuiz={setCurrentQuiz} customQuizActive={customQuizActive} setCustomQuizActive={setCustomQuizActive} />}
